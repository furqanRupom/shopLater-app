    ...
    return (
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-12 mr-12">
                    <Title name="Contact Us" />
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">If you face any problem we are always ready to solve your problem. But for that you have to contact with us</p>
                </div>
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full">
                            <button className="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Send Message</button>
                        </div>
