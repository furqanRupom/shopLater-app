...
const EcommerceBanner: React.FC<BannerProps> = ({
    ...
    const bannerStyle = {
        backgroundImage: `url(https://img.freepik.com/premium-photo/green-cute-pastel-abstract-texture-background-pattern-backdrop-gradient-wallpaper_41691-5371.jpg?size=626&ext=jpg)`,
    ...
    return (
        <div style={bannerStyle} >
            ...
            <div className="relative z-10 px-6  text-center lg:text-left text-gray-900">
                ...
                <h1 className="mb-4 text-2xl font-extrabold leading-tight lg:text-6xl bg-gradient-to-tr from-green-900 to-lime-600 text-transparent bg-clip-text">{title}</h1>
                <p className="mb-6 text-base font-normal leading-7 lg:w-3/4">{description}</p>
                <div className="flex flex-col items-center gap-4 lg:flex-row my-3">
                    ...
                    <button className="flex items-center py-4 text-sm font-medium px-7 bg-transparent border border-green-700 hover:bg-white hover:text-green-500 transition duration-300 rounded-2xl">
                ...
                <div className="relative  overflow-hidden ">
                    <Image width={1200} height={500} src="https://i.ibb.co/D7mLc1D/happy-smiling-man-holding-shopping-bags-green-background-132358-45954-Photoroom-png-Photoroom.png" alt="container image" />
                </div>
